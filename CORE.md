...
- **Name things by what they are.** No invented codenames, labels, or session-local shorthand in user-facing text — every finding or status should read as a plain sentence someone outside this session would understand on first read.
